...
<div class="container">
<h1 class="alert alert-dark text-center "; style="color:red;font-weight:bold">Ajouter un Contact </h1>
</div>
<div class="container">
...
<div class="modal-body">
  <div class="row mt-3">
    ...
    <div class="col-md-3">
          <input type="text" class="form-control" name="codeContact" id="codeContact" placeholder="Entrer le codeContact">
    </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-2">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-2">
        <select class="ui dropdown" name="fonction" required="required">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-2">
                <input type="text" class="form-control" name="fax" id="fax"  placeholder="Entrer le telephone">
            </div>
            <div class="col-md-2">
              <label for="fax" style="color:blue;font-weight:bold">Fax</label>
            </div>
            <div class="col-md-2">
              <input type="text" class="form-control" name="tel" id="fax"  placeholder="Entrer le fax">
            </div>
        </div>
          <div class="row mt-3">
            <div class="col-md-2">
