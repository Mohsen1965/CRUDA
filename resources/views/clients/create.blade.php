...
<div class="modal-body">
  <div class="row mt-3">
    ...
    <div class="col-md-2">
          <input type="text" class="form-control" name="code" id="code" placeholder="Entrer le code">
    </div>
    </div>
  <div class="row mt-3">
    <div class="col-md-2">
    ...
    <div class="col-md-4">
          <input type="text" class="form-control" name="raisonSociale" id="raisonSociale" placeholder="Entrer La raison Sociale">
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-2">
        <select class="ui dropdown" name="formeJuridique" required="required">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-2">
                <input type="text" class="form-control" name="tel" id="tel"  placeholder="Entrer le telephone">
            </div>
            <div class="col-md-2">
              <label for="fax" style="color:blue;font-weight:bold">Fax</label>
            </div>
            <div class="col-md-2">
              <input type="text" class="form-control" name="fax" id="fax"  placeholder="Entrer le fax">
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-2">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3">
              <input type="text" class="form-control" name="matriculeFiscal" id="matriculeFiscal"  placeholder="Entrer matricule fiscal">
            </div>
            <div class="col-md-3">
                <label for="registreCommerce" style="color:blue;font-weight:bold">Registre de Commerce </label>
            </div>
            <div class="col-md-3">
              <input type="text" class="form-control" name="registreCommerce" id="registreCommerce"  placeholder="Entrer Registre de Commerce">
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-2">
            ...
            <div class="col-md-3">
              <input type="text" class="form-control" name="rib" id="rib"  placeholder="Entrer RIB/RIP">
            </div>
            <div class="col-md-3">
                <label for="banque" style="color:blue;font-weight:bold">Banque </label>
            </div>
            <div class="col-md-3">
              <input type="text" class="form-control" name="banque" id="banque"  placeholder="Entrer la Banque">
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-2">
            ...
            <div class="col-md-3">
              <input type="text" class="form-control" name="codeContact" id="codeContact"  placeholder="Entrer Code Contact">
            </div>
            <div class="col-md-3">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-3">
                <input type="text" class="form-control" name="observations" id="observations"  placeholder="Entrer Observations">
              </div>
